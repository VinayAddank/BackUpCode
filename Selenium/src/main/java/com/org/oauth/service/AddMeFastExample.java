...
public class AddMeFastExample implements Runnable {
	...
	// Config
	String facebookEmail = "vinayaddanki5b8@gmail.com";
	String facebookPassword = "vinay143";
	String addmefastEmail = "vinayaddanki5b8@gmail.com";
	String addmefastPassword = "vinay143";
	...
	public void run() {
		try {
			...
			while (true) {
				...
				// This delay allows AddMeFast to detect the window close and request the next
				// page to Like
				sleep(5000);
